        ...
        <div className="max-w-5xl">
          <div className="mb-12 md:mb-20 perspective-1000">
            <h1 ref={titleRef} className="text-[clamp(4rem,12vw,10rem)] font-display font-bold leading-[0.8] tracking-tighter uppercase italic">
              <span className="block text-stroke-primary opacity-50">THE NEW</span>
              <span className="block text-white">PROXY</span>
              <span className="block text-primary">EDITION</span>
            </h1>
          </div>
          ...
          <div className="hero-content-reveal flex flex-col md:flex-row md:items-end gap-16 md:gap-24">
            <div className="flex-1">
              <p className="text-sm md:text-lg text-white/60 font-sans tracking-[0.2em] uppercase max-w-xl leading-loose">
                Redéfinir les standards de l&apos;excellence automobile. <br />
                Une sélection exclusive pour des conducteurs exigeants qui ne font aucun compromis.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-8 items-center">
              <a
                href="#vehicles"
                className="group relative px-10 md:px-12 py-5 md:py-6 bg-red-gradient rounded-sm overflow-hidden transition-all duration-500 hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(255,45,45,0.3)] hover:shadow-[0_0_50px_rgba(255,45,45,0.5)]"
              >
                <span className="relative z-10 text-white font-bold uppercase tracking-[0.3em] text-[10px]">Explorer la collection</span>
              ...
              <a
                href="#contact"
                className="group px-10 md:px-12 py-5 md:py-6 border border-white/10 rounded-sm text-white font-bold uppercase tracking-[0.3em] text-[10px] hover:bg-white hover:text-black transition-all duration-500 flex items-center gap-4"
              >
                Nous Contacter
